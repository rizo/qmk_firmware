...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUM] = LAYOUT(
      ...
      _C_USHM, _A_CDIR, _G_PDIR,  _S_SPC,   _INF,                    KC_MINS,    KC_4,    KC_5,    KC_6,    KC_0,
         _EUR,    _GBP,  _COPYR,   _SQRT, _SECTN,  XXXXXXX,        XXXXXXX,  KC_ASTR,    KC_7,    KC_8,    KC_9, KC_SLSH,
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,   KC_EQL, KC_UNDS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
