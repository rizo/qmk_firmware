...
//     RESET,        XXXXXXX,      XXXXXXX,   LT(_RS, KC_ESC), LSFT_T(KC_TAB), XXXXXXX,             KC_ENT,         LT(_LW, KC_SPC), XXXXXXX,         XXXXXXX,      XXXXXXX,      XXXXXXX),

//   [_RS] = LAYOUT(
//     XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,        XXXXXXX,                                           XXXXXXX,         KC_BSPC,        KC_UP,        KC_DEL,       XXXXXXX,
//     KC_LCTL,      KC_LALT,      KC_LGUI,      KC_LSFT,        XXXXXXX,                                           KC_BSPC,         KC_LEFT,        KC_DOWN,      KC_RIGHT,     XXXXXXX,
//     XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,        XXXXXXX,         XXXXXXX,         XXXXXXX,         XXXXXXX,         XXXXXXX,        XXXXXXX,      XXXXXXX,      XXXXXXX,
//     XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,        XXXXXXX,         KC_TRNS,         XXXXXXX,         KC_BSPC,         XXXXXXX,        XXXXXXX,      XXXXXXX,      XXXXXXX),

//   [_LW] = LAYOUT(
//     XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,        XXXXXXX,                                           XXXXXXX,         XXXXXXX,        XXXXXXX,      XXXXXXX,      XXXXXXX,
//     XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,        XXXXXXX,                                           XXXXXXX,         XXXXXXX,        XXXXXXX,      XXXXXXX,      XXXXXXX,
//     XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,        XXXXXXX,         XXXXXXX,         XXXXXXX,         XXXXXXX,         XXXXXXX,        XXXXXXX,      XXXXXXX,      XXXXXXX,
//     XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,        XXXXXXX,         XXXXXXX,         KC_TRNS,         XXXXXXX,         XXXXXXX,        XXXXXXX,      XXXXXXX,      XXXXXXX),
// };
...
#define _K_SYMBS LT(_L_SYM, KC_BSPC)
#define _K_SFTSP SFT_T(KC_SPC)
...
#define _K_C_A CTL_T(KC_A)
#define _K_A_R ALT_T(KC_R)
#define _K_G_S GUI_T(KC_S)
#define _K_S_T SFT_T(KC_T)

#define _K_S_N SFT_T(KC_N)
#define _K_G_E GUI_T(KC_E)
#define _K_A_I ALT_T(KC_I)
#define _K_C_O CTL_T(KC_O)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
       _K_C_A,  _K_A_R,  _K_G_S,  _K_S_T,    KC_D,                         KC_H,  _K_S_N,  _K_G_E,  _K_A_I,  _K_C_O,
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
         KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, XXXXXXX,    XXXXXXX,    KC_K,    KC_M, _K_COMM,  _K_DOT, _K_EXLM,
  //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
      XXXXXXX, XXXXXXX, XXXXXXX,MO(_L_NAV),_K_SFTSP,  KC_TAB,     _K_SYM,_K_SYMBS,  _K_ALT, XXXXXXX, XXXXXXX, XXXXXXX
                             //`--------------------------'  `--------------------------'
  ),

  [_L_NAV] = LAYOUT(
  //,--------------------------------------------.                    ,--------------------------------------------.
      _K_LOCK,_K_S_SPL,_K_S_APP,_K_S_TAB,_K_S_WIN,                      XXXXXXX, G(KC_Z),   KC_UP,S(G(KC_Z)), XXXXXXX,
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
      _K_OCTL, _K_OALT, _K_OGUI, _K_OSFT, _K_MUTE,                      _K_LN_L, KC_LEFT, KC_DOWN,KC_RIGHT, _K_LN_R,
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
      _______, _______, _______, _______, _K_VOLD, XXXXXXX,    XXXXXXX, XXXXXXX, G(KC_C), G(KC_V), G(KC_X), _K_FL_B,
  //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
      XXXXXXX, XXXXXXX, XXXXXXX, _K_NCTL, _K_NCMD, _______,    XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
                             //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
      KC_BSLS,  KC_DLR, KC_LCBR, KC_RCBR, KC_AMPR, XXXXXXX,    XXXXXXX, KC_ASTR,    KC_4,    KC_5,    KC_6, KC_SLSH,
  //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
      XXXXXXX, XXXXXXX, XXXXXXX, _K_SALT, _K_SCMD,  KC_EQL,    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
                             //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
      _K_EURO,  _K_PND,  _K_CDL, _K_CPRT, _K_SCTN, XXXXXXX,    XXXXXXX, _K_BLLT, _K_MDSH, _K_SQRT, _K_ELPS, _K_DIVD,
  //|--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
      XXXXXXX, XXXXXXX, XXXXXXX,  _K_LTE,  _K_GTE, _K_NEQL,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
                             //`--------------------------'  `--------------------------'
  )
};
