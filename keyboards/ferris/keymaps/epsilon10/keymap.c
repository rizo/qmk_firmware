...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ACT] = LAYOUT(
    XXXXXXX,  KC_ESC,    BACK,    FRWD,  INSERT,                      KC_PGUP,  KC_DEL, KC_UP,   KC_BSPC, KC_HOME,
      OSCTL,   OSALT,   OSGUI,   OSSFT, XXXXXXX,                      KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,
     RSTMOD,  REPEAT,    UNDO,    REDO,    REDO,                      XXXXXXX, SFT_TAB, KC_ESC,  KC_TAB,  XXXXXXX,
                                        _______, XXXXXXX,    KC_PENT, KC_BSPC
  ),

  [_SYM] = LAYOUT(
     KC_GRV,    KC_1,    KC_2,    KC_3,  KC_EQL,                      KC_ASTR, KC_LCBR, KC_DLR,  KC_RCBR, KC_CIRC,
       KC_0,    KC_4,    KC_5,    KC_6, KC_MINS,                      KC_PLUS, KC_LPRN, KC_PERC, KC_RPRN, KC_AMPR,
    KC_BSLS,    KC_7,    KC_8,    KC_9, KC_SLSH,                      KC_HASH, KC_LT,   KC_PIPE, KC_GT,   KC_TILD,
                                        KC_LBRC,   KC_RBRC,    XXXXXXX, _______
  ),

  [_FUN] = LAYOUT(
    XXXXXXX,   KC_F1,   KC_F2,   KC_F3,  KC_F10,                      DM_REC1, _MUTE,   _VOLD,   _VOLU,   XXXXXXX,
     KC_PWR,   KC_F4,   KC_F5,   KC_F6,  KC_F11,                      DM_RSTP, OSSFT,   OSGUI,   OSALT,   OSCTL,
